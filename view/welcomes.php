...
<body>
    ...
    <img src="img/logo.png" alt="Kichu ekta" style="width:200px ; length:200px">
        ...
        <h1>Hello, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. You have successfully logged in to Online Educational Platform. <br />Now you are ready to complete your advising.</h1>
    </div>
    <p>
    <div class="profile">
