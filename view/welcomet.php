...
<body>
    ...
    <img src="img/logo.png" alt="Kichu ekta" style="width:200px ; length:200px">
        ...
        <h1>Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. You have successfully logged in to Online Educational Platform. <br />Now you are ready to teach and check appointments.</h1>
    </div>
    <p>
    <div class="profile">
